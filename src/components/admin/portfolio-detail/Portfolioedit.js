...
class Peditslider extends Component {
    ...
    fetchData = () => {
        axios
            .post(
                Url.baseUrl + `api/portfoliodetail-edit/${this.props.params.id}`
            )
            .then((response) => {
                this.setState({
    ...
    removeImage = async (id) => {
        ...
        await axios
            .delete(Url.baseUrl + `api/delete-gallery-image/${id}`)
            .then(({ data }) => {
                Swal.fire({
                    icon: "success",
                    text: data.message,
                                                        ...
                                                        return (
                                                            ...
                                                            >
                                                                <img
                                                                    src={
                                                                        Url.baseUrl +
                                                                        "/public/uploads/portfoliodetail/" +
                                                                        data.image
                                                                    }
                                                                    style={{
                                                                        width: "100px",
