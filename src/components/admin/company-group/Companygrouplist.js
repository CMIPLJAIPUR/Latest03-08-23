...
class Companygrouplist extends Component {
    constructor(props) {
        super(props);
        this.state = {
            datalist: [],
    ...
    deleteCompanygroup = async (id) => {
        ...
        await axios
            .delete(Url.baseUrl + `api/delete-company-group/${id}`)
            .then(({ data }) => {
                Swal.fire({
                    icon: "success",
                    text: data.message,
                                ...
                                <tr key={proData.id}>
                                    ...
                                    <td>
                                        <img
                                            src={
                                                Url.baseUrl +
                                                `/public/uploads/company-group/${proData.image}`
                                            }
                                    ...
                                    <td>
                                        <Link
                                            to={`/admin/company-group-edit/${proData.id}`}
