...
export default class Addblog extends Component {
    constructor(props) {
        ...
        this.handleInputChangeDes = this.handleInputChangeDes.bind(this);
    }
    ...
    handleSubmit(e) {
        ...
        axios
            .post(Url.baseUrl + "api/blog-add", firstFormData, {})
            .then((res) => {
                ...
                if (
                    ...
                    this.setState({
                        ...
                        errMsgStatus: res.data.errors.status,
